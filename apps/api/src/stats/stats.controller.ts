...
async function verifyLinkOwnership(linksService: LinksService, slug: string, userId: string): Promise<void> {
...
export class StatsController {
  ...
  @Get(':slug')
  async getStats(@Param('slug') slug: string, @Req() req: AuthenticatedRequest): Promise<AggregatedStats> {
